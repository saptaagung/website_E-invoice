            ...
            >
                <div className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                        {logo ? (
                            <img src={logo} alt="Logo" className="size-8 rounded-lg object-cover flex-shrink-0" />
                        ) : (
                        ...
                        <div className="min-w-0 flex-1">
                            <h1 className="text-text-main dark:text-white text-lg font-bold leading-tight truncate" title={displayName}>
                                {displayName}
                            </h1>
                        </div>
                    </div>
                ...
                <div className="p-4 border-t border-border-light dark:border-border-dark">
                    ...
                    >
                        {logo ? (
                            <img src={logo} alt="Logo" className="size-8 rounded-full object-cover flex-shrink-0" />
                        ) : (
                        ...
                        <div className="flex flex-col flex-1 text-left min-w-0">
                            <p className="text-sm font-medium text-text-main dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors truncate">
                                {user?.name || 'Pengguna'}
                            </p>
