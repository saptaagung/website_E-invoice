...
import { quotations } from '@/lib/supabase-api';
...
export default function NewInvoiceSelector() {
    ...
    const handleConvertQuotation = () => {
        if (selectedQuotation) {
            ...
            router.push(`/invoices/new?from=quotation&ref=${selectedQuotation.id}`);
        }
    };
    ...
    return (
        <div className="flex flex-col gap-6 pb-10 max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-sm">
                <Link href="/invoices" className="text-text-secondary hover:text-primary">Faktur</Link>
